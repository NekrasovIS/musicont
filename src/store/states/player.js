// Начальное состояние для плеера
export default {
	// Состояние для текущей песни
	currentSong: {
		playback: {}, // Объект для управления воспроизведением (например, текущая позиция, скорость и т.д.)
		soundObj: {}, // Объект для управления звуковым объектом (например, ссылка на аудиофайл и его управление)
		detail: { // Детали текущей песни
			id: 1,
			title: 'Heartless', // Название песни
			author: 'The Weeknd', // Исполнитель
			img: 'https://res.cloudinary.com/jsxclan/image/upload/v1623984884/GitHub/Projects/Musicont/mock/images/heartless_du9yxe.jpg', // URL изображения обложки
			uri: 'https://res.cloudinary.com/jsxclan/video/upload/v1623987046/GitHub/Projects/Musicont/mock/audios/heartless_u7exot.mp3', // URL аудиофайла
			durationMillis: 249740, // Длительность песни в миллисекундах
		},
		playbackStatus: {}, // Статус воспроизведения (например, воспроизводится или остановлено)
	},
	// Список песен
	songs: [
		{
